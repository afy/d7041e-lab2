...
# 
model = gensim.models.Word2Vec(sentences, workers=3, min_count=1, sample=threshold, sg=1, vector_size=dimension) # create model using Word2Ve with the given parameters
#
